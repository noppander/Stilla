...
public class Balloon extends GameObject{
	...
	private static final int FRAME_HEIGHT = 68;
	
	// The ID so object can be identified.
	private static final String OBJECT_ID = "BALLOON";
	
	// The sounds effect when hit.
		Sound sound  = Gdx.audio.newSound(Gdx.files.internal("Music/sfx/balloon.wav"));
	 ...
	 * @param spriteSheet
	 */
	public Balloon(int posX, int posY, TextureRegion spriteSheet, SpriteBatch batch) {
