 ...
 *
 */
public class IceCloud extends GameObject{
	...
	private static final int FRAME_HEIGHT = 58;
	
	// The ID so object can be identified.
	private static final String OBJECT_ID = "ICE_CLOUD";
	
	// The sounds effect when hit.
		Sound sound  = Gdx.audio.newSound(Gdx.files.internal("Music/sfx/icecloud.wav"));
	 ...
	 * @param spriteSheet
	 */
	public IceCloud(int posX, int posY, TextureRegion spriteSheet, SpriteBatch batch) {
