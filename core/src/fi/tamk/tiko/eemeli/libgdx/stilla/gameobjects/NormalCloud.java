 ...
 *
 */
public class NormalCloud extends GameObject{
	...
	private static final int FRAME_WIDTH = 58;
	private static final int FRAME_HEIGHT = 38;
	
	// The ID so object can be identified.
	private static final String OBJECT_ID = "NORMAL_CLOUD";
	 ...
	 * @param spriteSheet
	 */
	public NormalCloud(int posX, int posY, TextureRegion spriteSheet, SpriteBatch batch) {
