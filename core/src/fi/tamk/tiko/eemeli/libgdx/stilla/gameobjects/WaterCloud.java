 ...
 *
 */
public class WaterCloud extends GameObject{
	...
	private static final int FRAME_HEIGHT = 57;
	
	// The ID so object can be identified.
	private static final String OBJECT_ID = "WATER_CLOUD";
	
	// The sounds effect when hit.
	Sound sound  = Gdx.audio.newSound(Gdx.files.internal("Music/sfx/watercloud.wav"));;
	 ...
	 * @param spriteSheet
	 */
	public WaterCloud(int posX, int posY, TextureRegion spriteSheet, SpriteBatch batch) {
