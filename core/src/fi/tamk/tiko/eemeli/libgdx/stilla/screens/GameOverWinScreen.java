 ...
 *
 */
public class GameOverWinScreen implements Screen {
	...
	private Skin skin = new Skin (Gdx.files.internal("Skin/CustomSkin/uiskin.json"));
		...
		public GameOverWinScreen(StillaGame game, SpriteBatch batch, OrthographicCamera camera) {
			
			// Save the score.
			StillaGame.prefs.putInteger("totalscore", ScoreCalculator.getInstance().getTotalScore());
			...
			musichandler.playMusic(Musics.GAMEOVERWIN);
